...
<spring:message code="reset.password.title" text="default" var="title"/>
        ...
        <div class="col-md-10">
            ...
            <form id="login-form" name="loginform" action="" method="post">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="loginEmail" name="loginEmail" placeholder="Email" minlength="3" value="${username}" readonly>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control" id="loginPassword" name="loginPassword" placeholder="New Password">
...
<script>
    ...
    var auth = {
        doLogin: function () {
            ...
            params['url'] = appRoutes.AUTH + appRoutes.RESET_PASSWORD;
            params['data'] = data;
        ...
        doneLogin: function(data) {
            ...
            if(data.reset == 'login') {
                ...
                commonFuns.displayResponse(appStrings.RESET_SUCCESS);
            } else {
                commonFuns.displayResponse(appStrings.RESET_FAIL);
            }
        },
        doNothing: function() {
            return false;
